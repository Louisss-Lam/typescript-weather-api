import { getHumidityValue, getSunTime, getWindDirection, getPop } from "../helpers";
...
const Forecast = ({ data }: Props): JSX.Element => {
  ...
  return (
    ...
    h-full lg:h-auto bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg"
    >
        <div className="mx-auto w-[300px]">
            ...
            <section className="flex flex-wrap justify-between text-zinc-700">
                ...
                backdrop-blur-ls rounded drop-shadow-lg py-4 mb-5">
                ...
                <Tile 
                    ...
                    description={`${getWindDirection(Math.round(today.wind.deg))}, gust ${today.wind.gust.toFixed(1)} km/h`}
                />
